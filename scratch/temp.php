...
<?php $__env->startPush('preloads'); ?>
    <link rel="preload" as="image" href="<?php echo e(asset('images/blog/' . preg_replace('/\.(jpg|jpeg|png|webp)$/i', '.avif', $tour->hero_image ?: 'evening-desert-safari-dubai-dune-discovery-tourism.avif'))); ?>" type="image/avif">
...
$value = context()->get($__contextArgs[0]); ?>": "https://schema.org/",
      "@type": "Product",
      "name": <?php echo json_encode($tour->name); ?>,
      "image": <?php echo json_encode(asset('images/blog/' . preg_replace('/\.(jpg|jpeg|png|webp)$/i', '.avif', $tour->hero_image ?: 'evening-desert-safari-dubai-dune-discovery-tourism.avif'))); ?>,
      "description": <?php echo json_encode(Str::limit(strip_tags($tour->short_desc ?: $tour->full_desc), 250)); ?>,
      "sku": "TOUR-<?php echo e($tour->id); ?>",
      "brand": {
        "@type": "Brand",
      ...
      "aggregateRating": {
        ...
        "ratingValue": "<?php echo e($tour->rating ?: '4.9'); ?>",
        "reviewCount": "<?php echo e($tour->review_count ?: '1247'); ?>"
      },
      "offers": {
        "@type": "Offer",
        "url": <?php echo json_encode(request()->url()); ?>,
        "priceCurrency": "AED",
        "price": "<?php echo e(number_format($tour->tiers->min('pivot.price') ?? 0, 2, '.', '')); ?>",
...
<!-- Tour Hero Section -->
<section class="tour-hero-modern position-relative d-flex align-items-end" style="min-height: 50vh; background: url('<?php echo e(asset('images/' . preg_replace('/\.(jpg|jpeg|png|webp)$/i', '.avif', $tour->hero_image))); ?>') center/cover no-repeat; margin-top: -var(--header-h);">
                            ...
                            <ul class="list-unstyled mb-0 row g-3">
                                ...
                                <li class="col-md-6 text-dark opacity-90 small d-flex gap-2 align-items-start fw-medium">
                                    ...
                                    <span>
                                        ...
                                        <?php if($na->description): ?>
                                         - <span class="fw-normal opacity-75"><?php echo e($na->description); ?></span>
                                        <?php endif; ?>
                                    </span>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<section class="section py-5 bg-light">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <?php $minPriceRel = $t->tiers->min('pivot.price') ?? 0; ?>
...
<div class="mobile-bookbar position-fixed bottom-0 start-0 w-100 bg-white p-3 border-top shadow-lg d-md-none d-flex align-items-center justify-content-between z-3 safe-area-bottom">
    ...
    <button class="btn btn-desert-animated rounded-pill px-4 py-2.5 shadow-sm fw-bold border-0" data-bs-toggle="modal" data-bs-target="#bookingModal" data-action="open-booking" data-tour="<?php echo e($tour->id); ?>">
