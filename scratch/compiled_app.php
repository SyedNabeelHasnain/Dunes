...
<head>
    ...
    <meta name="keywords" content="<?php echo e($pageKeys); ?>">
    ...
    <?php if(!empty($gVerify)): ?>
    <meta name="google-site-verification" content="<?php echo e($gVerify); ?>">
    <?php endif; ?>
    ...
    <!-- Stylesheets -->
    <link href="<?php echo e(asset('assets/vendor/bootstrap/5.3.2/css/bootstrap.min.css')); ?>" rel="stylesheet">
    <link rel="preload" href="<?php echo e(asset('assets/vendor/bootstrap-icons/1.11.3/font/bootstrap-icons.min.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="<?php echo e(asset('assets/vendor/bootstrap-icons/1.11.3/font/bootstrap-icons.min.css')); ?>"></noscript>
    <link href="<?php echo e(asset('assets/css/app.min.css')); ?>?v=<?php echo e($cacheVer); ?>" rel="stylesheet">
    <link rel="preload" href="<?php echo e(asset('assets/vendor/intl-tel-input/26.0.6/build/intlTelInput.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="<?php echo e(asset('assets/vendor/intl-tel-input/26.0.6/build/intlTelInput.css')); ?>"></noscript>
    ...
    <script>
      ...
      var initThirdPartyTracking = function() {
          ...
          <?php if($googleActive && !empty($ga4Id)): ?>
          var sGa = document.createElement('script');
          sGa.async = true;
          sGa.src = "https://www.googletagmanager.com/gtag/js?id=<?php echo e($ga4Id); ?>";
          document.head.appendChild(sGa);
          gtag('config', '<?php echo e($ga4Id); ?>');
          <?php endif; ?>

          <?php if($metaActive && !empty($metaPixelId)): ?>
          !function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?
          n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;
          n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;
          t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,
          document,'script','https://connect.facebook.net/en_US/fbevents.js');
          if(window.fbq){ fbq('init', '<?php echo e($metaPixelId); ?>'); fbq('track', 'PageView'); }
          <?php endif; ?>
      };
    ...
    <?php echo $__env->yieldPushContent('preloads'); ?>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <?php if($googleActive && !empty($gtmId) && strpos($gtmId, 'G-') !== 0): ?>
    ...
    <?php endif; ?>
    <?php if($metaActive && !empty($metaPixelId)): ?>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=<?php echo e($metaPixelId); ?>&ev=PageView&noscript=1"/></noscript>
    <?php endif; ?>
    ...
    <header id="header" class="fixed-top transition-all">
        <nav class="navbar navbar-expand-lg navbar-light glass-nav sticky-sm-top sticky-md-top sticky-lg-top">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center p-0" href="<?php echo e(route('home')); ?>">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Dunes Discovery Tourism" width="160" height="46" class="img-fluid logo-img" fetchpriority="high">
                </a>
                ...
                <div class="d-flex align-items-center gap-2 d-lg-none">
                    <div class="nav-review-circle" onclick="toggleReviewPopover(this, event)" id="taCircle" style="position: relative; cursor: pointer;">
                        <img src="<?php echo e(asset('images/tripadvisor-color-logo.svg')); ?>" alt="TripAdvisor">
                    </div>
                    <div class="nav-review-circle" onclick="toggleReviewPopover(this, event)" id="googleCircle" style="position: relative; cursor: pointer;">
                        <img src="<?php echo e(asset('images/Google-G.avif')); ?>" alt="Google">
                    </div>
                    <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/','',$waPhone)); ?>" class="btn-circle-whatsapp" aria-label="WhatsApp" target="_blank" rel="noopener"><i class="bi bi-whatsapp"></i></a>
                ...
                <div class="offcanvas offcanvas-end border-0 rounded-start-4" tabindex="-1" id="mainOffcanvas" aria-labelledby="mainOffcanvasLabel" style="max-width: 75%;">
                    <div class="offcanvas-header border-bottom py-3">
                        <div class="offcanvas-title d-flex align-items-center" id="mainOffcanvasLabel">
                            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Dunes Discovery" width="140" height="40" class="img-fluid">
                        </div>
                    ...
                    <div class="offcanvas-body p-4 p-lg-0">
                        <ul class="navbar-nav mx-auto mb-4 mb-lg-0 gap-lg-1 text-nowrap">
                            <li class="nav-item">
                                <a class="nav-link px-3 px-lg-2 py-2 rounded-3 <?php echo e(request()->routeIs('home') ? 'active bg-primary-subtle text-primary fw-semibold' : ''); ?>" href="<?php echo e(route('home')); ?>">Home</a>
                            </li>
                            <li class="nav-item dropdown align-items-center flex-wrap w-100 w-lg-auto">
                                <div class="d-flex flex-wrap align-items-stretch w-100 rounded-3 position-relative <?php echo e(request()->routeIs('tours.*') ? 'bg-primary-subtle' : ''); ?>">
                                    <a class="nav-link px-3 px-lg-2 py-2 flex-grow-1 rounded-start-3 <?php echo e(request()->routeIs('tours.*') ? 'active text-primary fw-semibold' : ''); ?>" href="<?php echo e(route('tours.index')); ?>">Tours</a>
                                    <a class="nav-link px-2 py-2 dropdown-toggle dropdown-toggle-split d-flex align-items-center rounded-end-3 border-start border-primary border-opacity-10 <?php echo e(request()->routeIs('tours.*') ? 'active text-primary' : ''); ?>" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <span class="visually-hidden">Toggle Dropdown</span>
                                    </a>
                                    <ul class="dropdown-menu border-0 shadow-lg rounded-4 overflow-hidden p-0 mt-2 dropdown-animated-border">
                                        <?php $__currentLoopData = $allTours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a class="dropdown-item rounded-0 py-3 position-relative animated-divider-item" href="<?php echo e(route('tours.show', $t->slug)); ?>"><?php echo e($t->name); ?></a></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link px-3 px-lg-2 py-2 rounded-3 <?php echo e(request()->routeIs('about') ? 'active bg-primary-subtle text-primary fw-semibold' : ''); ?>" href="<?php echo e(route('about')); ?>">About Us</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link px-3 px-lg-2 py-2 rounded-3 <?php echo e(request()->routeIs('blog.*') ? 'active bg-primary-subtle text-primary fw-semibold' : ''); ?>" href="<?php echo e(route('blog.index')); ?>">Blog</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link px-3 px-lg-2 py-2 rounded-3 <?php echo e(request()->routeIs('faq') ? 'active bg-primary-subtle text-primary fw-semibold' : ''); ?>" href="<?php echo e(route('faq')); ?>">FAQ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link px-3 px-lg-2 py-2 rounded-3 <?php echo e(request()->routeIs('contact') ? 'active bg-primary-subtle text-primary fw-semibold' : ''); ?>" href="<?php echo e(route('contact')); ?>">Contact</a>
                            </li>
                        </ul>
                        <div class="d-flex flex-column flex-lg-row gap-3 align-items-stretch align-items-lg-center">
                            <a class="btn btn-whatsapp-animated rounded-pill px-4 fw-semibold d-inline-flex align-items-center justify-content-center gap-2" href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/','',$waPhone)); ?>" target="_blank" rel="noopener">
        ...
        <div class="container">
            <div class="row g-4 mb-5">
                <div class="col-12 col-lg-4">
                    <img src="<?php echo e(asset('images/logo-white.png')); ?>" alt="Dunes Discovery Tourism" width="160" height="46" class="mb-4" style="height: auto; width: 160px; object-fit: contain;">
                    ...
                    <div class="d-flex gap-3 mt-4">
                        ...
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/','',$waPhone)); ?>" target="_blank" rel="noopener" class="btn btn-outline-light btn-sm rounded-circle p-0 d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;" aria-label="Chat with Dunes Discovery Tourism on WhatsApp"><i class="bi bi-whatsapp"></i></a>
                    </div>
                </div>
                <div class="col-6 col-lg-2">
                    <h4 class="h6 fw-bold text-uppercase mb-4">Desert Safaris</h4>
                    <ul class="list-unstyled mb-0 d-grid gap-2">
                        <li><a href="<?php echo e(route('tours.show', 'evening-desert-safari-dubai')); ?>" class="text-white-50 text-decoration-none small">Evening Safari</a></li>
                        <li><a href="<?php echo e(route('tours.show', 'morning-desert-safari-dubai')); ?>" class="text-white-50 text-decoration-none small">Morning Safari</a></li>
                        <li><a href="<?php echo e(route('tours.show', 'overnight-desert-safari-dubai')); ?>" class="text-white-50 text-decoration-none small">Overnight Safari</a></li>
                        <li><a href="<?php echo e(route('tours.show', 'desert-safari-quad-biking-dubai')); ?>" class="text-white-50 text-decoration-none small">Quad Biking Safari</a></li>
                    </ul>
                    <a href="https://www.tripadvisor.com/Attraction_Review-g295424-d29026644-Reviews-Dunes_Discovery-Dubai_Emirate_of_Dubai.html" target="_blank" rel="noopener" class="footer-badge mt-4 d-flex align-items-center text-decoration-none">
                        <img src="<?php echo e(asset('images/tripadvisor-logo-circle-owl-icon-black-green.png')); ?>" alt="TripAdvisor" class="footer-badge-logo" style="width:24px; height:24px; margin-right:8px;">
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="list-unstyled mb-0 d-grid gap-2">
                        <li><a href="<?php echo e(route('tours.show', 'dubai-city-tour')); ?>" class="text-white-50 text-decoration-none small">Dubai City Tour</a></li>
                        <li><a href="<?php echo e(route('tours.show', 'abu-dhabi-city-tour-from-dubai')); ?>" class="text-white-50 text-decoration-none small">Abu Dhabi Tour</a></li>
                        <li><a href="<?php echo e(route('tours.show', 'dhow-cruise-catamaran-cruise-dinner-dubai')); ?>" class="text-white-50 text-decoration-none small">Marina Cruise</a></li>
                    </ul>
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <ul class="list-unstyled mb-0 d-grid gap-3">
                        <li><a href="tel:<?php echo e(preg_replace('/[^0-9+]/','',$phone)); ?>" class="text-white-50 text-decoration-none small d-flex align-items-center gap-2"><i class="bi bi-telephone text-primary"></i><?php echo e($phone); ?></a></li>
                        <li><a href="mailto:<?php echo e($email); ?>" class="text-white-50 text-decoration-none small d-flex align-items-center gap-2"><i class="bi bi-envelope text-primary"></i><?php echo e($email); ?></a></li>
                        <li><a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/','',$waPhone)); ?>" target="_blank" rel="noopener" class="text-white-50 text-decoration-none small d-flex align-items-center gap-2"><i class="bi bi-whatsapp text-primary"></i>WhatsApp Chat</a></li>
            ...
            <div class="border-top border-secondary pt-4">
                <div class="d-flex flex-column flex-md-row align-items-center justify-content-between gap-3">
                    <p class="text-white-50 small mb-0">&copy; <?php echo e(date('Y')); ?> Dunes Discovery Tourism. All rights reserved.</p>
                    <div class="d-flex align-items-center gap-3 footer-trust-icons">
                        <img src="<?php echo e(asset('images/ziina-icon.png')); ?>" alt="Ziina Payment Gateway" width="18" height="18" style="filter: invert(1); opacity: 0.6;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php echo $__env->make('partials.booking-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <!-- Scripts -->
    <script src="<?php echo e(asset('assets/vendor/bootstrap/5.3.2/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/intl-tel-input/26.0.6/build/intlTelInput.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/app.js')); ?>?v=<?php echo e($cacheVer); ?>"></script>
