                    ...
                    <div class="booking-scroll-area p-4 flex-grow-1 overflow-y-auto">
                        ...
                        <div class="step-content active" data-step="1">
                            <div class="mb-4" id="tourSelectWrapper">
                                ...
                                <div class="form-floating">
                                    <select class="form-select border-0 shadow-sm rounded-4 fw-bold" id="bookingTour" name="tour_id" required style="height: 60px;" autocomplete="off">
                                        ...
                                        <?php $__currentLoopData = $modalTours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" class="form-control visually-hidden" name="date" id="bookingDate" required min="<?php echo e($minDate); ?>" autocomplete="off">
                            </div>
                        ...
                        <div class="step-content d-none" data-step="2">
                            ...
                            <div class="mb-4">
                                ...
                                <?php echo renderFloatingTextarea([
                                    'id' => 'bookingRequests',
                                    'name' => 'requests',
                            ...
                            <div class="mb-4" id="paymentOptions" data-ziina-active="<?php echo e($ziinaActive ? '1' : '0'); ?>" data-advance-percent="<?php echo e($advancePercent); ?>">
                                ...
                                <div class="payment-options">
                                    ...
                                    <div class="payment-option" data-value="advance">
                                        ...
                                        <div class="payment-option-sub">Hold slot (<?php echo e($advancePercent); ?>%)</div>
                                    </div>
                            ...
                            <div class="mb-3">
                                <div class="legal-agreement-wrapper">
                                    ...
                                    <label class="legal-agreement-text" for="bookingAgreement">
                                        I agree to the <a href="<?php echo e(route('terms')); ?>" target="_blank" class="legal-link">Terms & Conditions</a> and <a href="<?php echo e(route('privacy')); ?>" target="_blank" class="legal-link">Privacy Policy</a>.
                                    </label>
                                </div>
                            </div>
                        </div>
