...
<section class="hero-modern position-relative d-flex align-items-center justify-content-center overflow-hidden" style="min-height: 90vh;">
    <video class="hero-video position-absolute top-0 start-0 w-100 h-100" autoplay loop muted playsinline id="heroVideo" poster="<?php echo e(asset('images/desert-safari-poster.avif')); ?>" style="object-fit: cover; z-index: -1;">
    </video>
...
<section class="section py-5">
    <div class="container py-lg-4">
        ...
        <div class="row g-4 mb-5">
            <?php $__currentLoopData = $bestsellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    ...
                    <article class="card card-modern h-100 border-0 shadow-sm">
                        <a href="<?php echo e(route('tours.show', $t->slug)); ?>" class="text-decoration-none text-dark d-flex flex-column h-100">
                            <div class="card-img-wrapper position-relative overflow-hidden" style="aspect-ratio: 16/10;">
                                <img src="<?php echo e(asset('images/' . preg_replace('/\.(jpg|jpeg|png|webp)$/i', '.avif', $t->thumb_image))); ?>" class="card-img-top w-100 h-100" alt="<?php echo e($t->name); ?>" loading="lazy" style="object-fit: cover;">
                                ...
                                <div class="position-absolute bottom-0 start-0 w-100 p-3" style="background: linear-gradient(0deg, rgba(0,0,0,0.6) 0%, transparent 100%);">
                                    <span class="badge glass text-white fw-semibold">
                                        <i class="bi bi-tag-fill me-1"></i><?php echo e($category ? $category->name : 'Tours'); ?>
                            ...
                            <div class="card-body p-4 d-flex flex-column flex-grow-1">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-auto pt-3">
                                    <div>
                                        ...
                                        <span class="h5 fw-bold text-primary mb-0">AED <?php echo e(number_format($minPrice)); ?></span>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <button type="button" class="btn-circle-whatsapp fab-whatsapp" data-tour-name="<?php echo e($t->name); ?>" aria-label="Book <?php echo e($t->name); ?> via WhatsApp">
        ...
        <div class="text-center">
            <a href="<?php echo e(route('tours.index')); ?>" class="btn btn-desert-animated-dark btn-lg rounded-pill px-5 py-3 fw-bold">
...
<section class="reviews-section bg-soft-primary py-5 overflow-hidden">
    ...
    <div class="reviews-marquee mb-4">
        <div class="reviews-track d-flex gap-4">
            <?php $__currentLoopData = $googleReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo renderReviewCardMarkup($r); ?>
    ...
    <div class="reviews-marquee reverse">
        <div class="reviews-track d-flex gap-4">
            <?php $__currentLoopData = $tripReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo renderReviewCardMarkup($r); ?>
...
<section class="section py-5 bg-light">
    <div class="container py-lg-4">
        ...
        <div class="accordion accordion-flush mx-auto" id="faqAccordion" style="max-width: 800px;">
            ...
            <div class="accordion-item border-animated bg-white mb-3 rounded-4 border-0 shadow-sm">
                <h3 class="accordion-header">
                    <button class="accordion-button collapsed rounded-4 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq-<?php echo e($index); ?>">
                        <?php echo e($f->question); ?>

                    </button>
                </h3>
                <div id="faq-<?php echo e($index); ?>" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
        ...
        <div class="text-center mt-5 pb-3">
            <a href="<?php echo e(route('faq')); ?>" class="btn btn-desert-animated rounded-pill px-5 py-3 d-inline-flex align-items-center gap-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadHeroVideo() {
        ...
        if (v && !v.querySelector('source')) {
            ...
            s.src = "<?php echo e(asset('images/desert-safar-dubai-tour-short-dune-discovery-tourism.mp4')); ?>";
            s.type = "video/mp4";
            v.appendChild(s);
            v.load();
        }
