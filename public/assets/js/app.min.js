...
const eventParams={'send_to':'AW-17859624049/eR3SCLimtvobEPH4kMRC','value':totalVal,'currency':'AED','transaction_id':data.reference||('REF-'+Date.now())};
if(typeof window.gtag==='function'){
gtag('event','conversion',eventParams);
gtag('event','conversion_event_submit_lead_form',eventParams);
}
if(window.dataLayer){
window.dataLayer.push({
event:'generate_lead',
