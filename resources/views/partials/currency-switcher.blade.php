    ...
    <div x-show="open" 
        ...
        <div class="space-y-1 mt-1">
            <button type="button" @click="open = false" class="w-full rounded-xl px-2.5 py-2 text-xs font-semibold text-slate-700 hover:bg-orange-50 hover:text-primary flex items-center justify-between transition-colors currency-option active" data-currency="AED" data-flag="&#x1F1E6;&#x1F1EA;" data-symbol="AED" data-rate="1">
                <span class="flex items-center gap-2"><span class="text-base">&#x1F1E6;&#x1F1EA;</span><span>AED <small class="text-slate-500">(Ø¯.Ø¥)</small></span></span>
            ...
            <button type="button" @click="open = false" class="w-full rounded-xl px-2.5 py-2 text-xs font-semibold text-slate-700 hover:bg-orange-50 hover:text-primary flex items-center justify-between transition-colors currency-option" data-currency="EUR" data-flag="&#x1F1EA;&#x1F1FA;" data-symbol="â‚¬" data-rate="{{ $rateEur }}">
                <span class="flex items-center gap-2"><span class="text-base">&#x1F1EA;&#x1F1FA;</span><span>EUR <small class="text-slate-500">(â‚¬)</small></span></span>
                <i class="bi bi-check2 text-primary font-bold checkmark hidden"></i>
            </button>
            <button type="button" @click="open = false" class="w-full rounded-xl px-2.5 py-2 text-xs font-semibold text-slate-700 hover:bg-orange-50 hover:text-primary flex items-center justify-between transition-colors currency-option" data-currency="GBP" data-flag="&#x1F1EC;&#x1F1E7;" data-symbol="Â£" data-rate="{{ $rateGbp }}">
                <span class="flex items-center gap-2"><span class="text-base">&#x1F1EC;&#x1F1E7;</span><span>GBP <small class="text-slate-500">(Â£)</small></span></span>
                <i class="bi bi-check2 text-primary font-bold checkmark hidden"></i>
            </button>
            <button type="button" @click="open = false" class="w-full rounded-xl px-2.5 py-2 text-xs font-semibold text-slate-700 hover:bg-orange-50 hover:text-primary flex items-center justify-between transition-colors currency-option" data-currency="SAR" data-flag="&#x1F1F8;&#x1F1E6;" data-symbol="SAR" data-rate="{{ $rateSar }}">
                <span class="flex items-center gap-2"><span class="text-base">&#x1F1F8;&#x1F1E6;</span><span>SAR <small class="text-slate-500">(ï·¼)</small></span></span>
                <i class="bi bi-check2 text-primary font-bold checkmark hidden"></i>
            </button>
            <button type="button" @click="open = false" class="w-full rounded-xl px-2.5 py-2 text-xs font-semibold text-slate-700 hover:bg-orange-50 hover:text-primary flex items-center justify-between transition-colors currency-option" data-currency="INR" data-flag="&#x1F1EE;&#x1F1F3;" data-symbol="â‚¹" data-rate="{{ $rateInr }}">
                <span class="flex items-center gap-2"><span class="text-base">&#x1F1EE;&#x1F1F3;</span><span>INR <small class="text-slate-500">(â‚¹)</small></span></span>
                <i class="bi bi-check2 text-primary font-bold checkmark hidden"></i>
            </button>
        </div>
    </div>
