<div class="dropdown currency-switcher-dropdown d-inline-block">
    ...
    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-4 p-2 mt-2" aria-labelledby="currencyDropdownBtn" style="min-width: 175px; z-index: 1060;">
        ...
        <li>
            <button type="button" class="dropdown-item rounded-3 py-2 d-flex align-items-center justify-content-between currency-option" data-currency="USD" data-flag="🇺🇸" data-symbol="$" data-rate="0.2723">
                <span><span class="me-2">🇺🇸</span>USD <small class="text-muted">($)</small></span>
                <i class="bi bi-check2 checkmark d-none"></i>
            </button>
        </li>
        <li>
            <button type="button" class="dropdown-item rounded-3 py-2 d-flex align-items-center justify-content-between currency-option" data-currency="EUR" data-flag="🇪🇺" data-symbol="€" data-rate="0.2510">
                <span><span class="me-2">🇪🇺</span>EUR <small class="text-muted">(€)</small></span>
                <i class="bi bi-check2 checkmark d-none"></i>
            </button>
        </li>
        <li>
            <button type="button" class="dropdown-item rounded-3 py-2 d-flex align-items-center justify-content-between currency-option" data-currency="GBP" data-flag="🇬🇧" data-symbol="£" data-rate="0.2150">
                <span><span class="me-2">🇬🇧</span>GBP <small class="text-muted">(£)</small></span>
                <i class="bi bi-check2 checkmark d-none"></i>
            </button>
        </li>
        <li>
            <button type="button" class="dropdown-item rounded-3 py-2 d-flex align-items-center justify-content-between currency-option" data-currency="SAR" data-flag="🇸🇦" data-symbol="SAR" data-rate="1.0210">
                <span><span class="me-2">🇸🇦</span>SAR <small class="text-muted">(﷼)</small></span>
                <i class="bi bi-check2 checkmark d-none"></i>
            </button>
        </li>
        <li>
            <button type="button" class="dropdown-item rounded-3 py-2 d-flex align-items-center justify-content-between currency-option" data-currency="INR" data-flag="🇮🇳" data-symbol="₹" data-rate="22.85">
