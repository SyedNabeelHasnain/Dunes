     ...
     x-data="{
        ...
        book() {
            ...
            setTimeout(() => {
                ...
                if (promoInput) {
                    promoInput.value = '{{ $conciergePromoCode }}';
        ...
        get waUrl() {
            ...
            const codeText = '{{ $conciergePromoActive ? " with code " . $conciergePromoCode : "" }}';
            ...
            return `https://wa.me/{{ preg_replace('/[^0-9]/','',$waPhone) }}?text=${text}`;
        }
     }"
