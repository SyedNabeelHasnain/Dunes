...
<div id="globalSearchModal"
    ...
    <div x-show="$store.modal.active === 'search'"
         ...
         class="fixed inset-0 bg-slate-950/70 backdrop-blur-sm transition-opacity z-0"
    ...
    <div class="relative z-10 min-h-full flex items-center justify-center p-3 sm:p-4 text-center">
        <div x-show="$store.modal.active === 'search'"
            ...
            <div class="flex items-center justify-between p-4 sm:p-6 pb-0">
                ...
                <button type="button" @click="$store.modal.close()" class="w-8 h-8 rounded-full bg-slate-100 text-slate-500 hover:text-slate-800 hover:bg-slate-200 flex items-center justify-center transition-colors cursor-pointer" aria-label="Close">
