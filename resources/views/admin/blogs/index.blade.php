                    ...
                    <tr>
                        <td class="ps-4">
                            <div class="d-flex align-items-center gap-3">
                                @if($p->featured_image)
                                    <img src="{{ asset('images/blog/' . $p->featured_image) }}" alt="{{ $p->title }}" style="width: 50px; height: 50px; object-fit: cover; border-radius: 6px;" class="border" onerror="this.src='{{ asset('images/desert-safari-poster.avif') }}'">
                                @else
                                    <img src="{{ asset('images/desert-safari-poster.avif') }}" alt="Default post thumbnail" style="width: 50px; height: 50px; object-fit: cover; border-radius: 6px;" class="border">
                                @endif
                                <div>
