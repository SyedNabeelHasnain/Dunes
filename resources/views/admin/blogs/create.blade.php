                ...
                <div class="col-lg-8">
                    <div class="p-4 bg-light rounded-4 border mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" id="post_title" class="form-control" value="{{ old('title') }}" placeholder="e.g. 10 Best Things to Do in Dubai Desert" required style="height: 48px; border-radius: 8px;">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="excerpt" id="excerpt" class="form-control" rows="2" placeholder="Brief summary displayed on listings" required style="border-radius: 8px;">{{ old('excerpt') }}</textarea>
                        </div>

                        <div class="mb-0">
                            <label for="content" class="form-label fw-bold text-dark">Main Article Content</label>
                            <textarea name="content" id="content" class="form-control wysiwyg-editor" rows="12" placeholder="Write article here..." required style="border-radius: 8px;">{{ old('content') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-light rounded-4 border mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="author_name" id="author_name" class="form-control" value="{{ old('author_name', 'Dunes Discovery') }}" placeholder="Dunes Discovery">
                            </div>
                            <div class="col-md-6">
                                <label for="author_title" class="form-label fw-bold text-dark">Author Job Title</label>
                                <input type="text" name="author_title" id="author_title" class="form-control" value="{{ old('author_title', 'Dubai Tourism Expert') }}" placeholder="Dubai Tourism Expert">
                            </div>
                            <div class="col-12">
                                <label for="author_bio" class="form-label fw-bold text-dark">Author Short Biography</label>
                                <textarea name="author_bio" id="author_bio" class="form-control" rows="2" placeholder="Biographical details shown at post footer">{{ old('author_bio') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-light rounded-4 border mb-0">
                        ...
                        <div class="mb-0">
                            <textarea name="ai_summary" id="ai_summary" class="form-control" rows="2" placeholder="A brief bulleted AI-generated summary shown in an highlight box at the top of the post">{{ old('ai_summary') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="p-4 bg-light rounded-4 border mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" name="published_at" id="published_at" class="form-control" value="{{ old('published_at') }}" style="border-radius: 8px;">
                        </div>

                        <div class="mb-3">
                            <label for="read_time" class="form-label fw-bold text-dark">Est. Read Time (Minutes)</label>
                            <input type="number" name="read_time" id="read_time" class="form-control" value="{{ old('read_time', 5) }}" required style="border-radius: 8px;">
                        </div>
                    ...
                    <div class="p-4 bg-light rounded-4 border mb-4">
                        ...
                        <div class="mb-0">
                            ...
                            <input type="text" name="tags[]" id="tags_input" class="form-control" value="{{ is_array(old('tags')) ? implode(', ', old('tags')) : old('tags') }}" placeholder="dubai, safari, adventure">
                    ...
                    <div class="p-4 bg-light rounded-4 border mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="meta_title" id="meta_title" class="form-control form-control-sm" value="{{ old('meta_title') }}">
                        </div>
                        <div class="mb-3">
                            <label for="meta_desc" class="form-label fw-bold text-dark small">Meta Description</label>
                            <textarea name="meta_desc" id="meta_desc" class="form-control form-control-sm" rows="3">{{ old('meta_desc') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="meta_keywords" class="form-label fw-bold text-dark small">Meta Keywords</label>
                            <input type="text" name="meta_keywords" id="meta_keywords" class="form-control form-control-sm" value="{{ old('meta_keywords') }}">
                        </div>
                        <div class="mb-0">
                            <label for="canonical_url" class="form-label fw-bold text-dark small">Canonical URL Override</label>
                            <input type="url" name="canonical_url" id="canonical_url" class="form-control form-control-sm" value="{{ old('canonical_url') }}" placeholder="https://...">
                        </div>
                    </div>
